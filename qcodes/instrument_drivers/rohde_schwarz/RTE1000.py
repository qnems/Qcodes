# All manual references are to R&S RTE Digital Oscilloscope User Manual
...
class ScopeTrace(ArrayParameter):
    ...
    def get_raw(self):
        ...
        self.channel._parent.run_single()
...
class RTE1000(VisaInstrument):
    """
    QCoDeS Instrument driver for the
    Rohde-Schwarz RTE1000 series oscilloscopes.
...
# from qcodes.instrument.channel import InstrumentChannel
# from .RTO1000 import RTO1000, ScopeTrace

# # class RTEScopeTrace(ScopeTrace):

# # 	def __init__(self, name: str, instrument: InstrumentChannel,
# #                  channum: int) -> None:

# # 		super().__init__(self, name, instrument, channum)

# def new_get_raw(self, check_after=0.5):
# 	print("New one called")
# 	self.channel._parent.run_single()
# 	self.channel._parent.wait_till_complete(check_after=check_after)
# 	super().get_raw()

# class RTE1000(RTO1000):
...
# 						 model, timeout, HD,
# 						 terminator, **kwargs)
# 		self.ch1.trace.get_raw = new_get_raw
# 		print(self.ch1.trace())